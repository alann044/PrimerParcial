...
//$conexion->query("SET time_zone = 'America/Ciudad_Juarez'");
...
$persona_visitar = $_POST['persona_visitar'];

$contraseña_hash = password_hash($contraseña, PASSWORD_DEFAULT);

$sql = "INSERT INTO visitantes (nombre, correo, contraseña, ocupacion, motivo_visita, persona_visitar) 
        VALUES (?, ?, ?, ?, ?, ?)";
$stmt = $conexion->prepare($sql);
$stmt->bind_param("ssssss", $nombre, $correo, $contraseña_hash, $ocupacion, $motivo_visita, $persona_visitar);
?>
<!DOCTYPE html>
<html lang="es">
<head>
